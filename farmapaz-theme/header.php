...
<header class="sticky top-0 z-50 transition-shadow duration-300">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-9 sm:h-10">
                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <a href="tel:04128798885" class="sm:hidden flex items-center gap-1 bg-brand-yellow text-brand-blue px-2 py-0.5 rounded font-bold text-xs hover:bg-yellow-400 transition-colors">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        Llamar
                    </a>
                    <a href="https://wa.me/584128798885" target="_blank"
                       class="hidden sm:flex items-center gap-1.5 bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-full text-xs font-semibold transition-all hover:shadow-lg">
            ...
            <div class="flex items-center justify-between h-14 sm:h-16 lg:h-20">
                ...
                <div class="hidden lg:flex flex-1 max-w-lg mx-8">
                    <div class="relative w-full">
                        <form role="search" method="get" action="<?= esc_url(home_url('/')); ?>" class="relative">
                            <input type="text" name="s" placeholder="Busca aquí tu producto..."
                                   class="w-full pl-10 pr-4 py-2.5 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-green" style="background: #fafcfa; border: 2px solid rgba(90,125,67,0.2);">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-brand-green">
    ...
    <!-- Search (mobile) -->
    <div class="lg:hidden px-4 pb-3 pt-0" style="background: linear-gradient(135deg, #ffffff 0%, #f8faf6 50%, #fefaf0 100%);">
        <form role="search" method="get" action="<?= esc_url(home_url('/')); ?>" class="relative">
            <input type="text" name="s" placeholder="Buscar..."
                   class="w-full pl-9 pr-3 py-2 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-green" style="background: #fafcfa; border: 2px solid rgba(90,125,67,0.2);">
            <span class="absolute left-2.5 top-1/2 -translate-y-1/2 text-brand-green">
